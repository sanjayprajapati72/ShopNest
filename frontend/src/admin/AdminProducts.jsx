    ...
    return (
        <div style={containerStyle}>
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:'20px'}}>
                <h2 style={{color:'#f97316'}}> Manage Product</h2>
                <Link to ="/admin/add-product" className="btn" style={{width: '180px', height: '50px', borderRadius: '12px', fontSize: '15px', fontWeight: '600',transition: "all 0.3s ease",}}>+ Add Product</Link>
            </div>
