                ...
                <table style={tableStyle}>
                    ...
                    <tbody>
                        {users.map(u =>(
                            ...
                            <td style={tdStyle}>
                                <span style={{background:u.role === 'admin' ? 'rgba(234,88,12,0,0.2)':'rgba(16, 185, 129,0.2)',color:u.role === 'admin' ? '#f97316'
 ...
 const containerStyle ={
    ...
    const rowStyle={boderBottom:'1px soild rgba(255,255,255,0.1)'};
